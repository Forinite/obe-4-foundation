...
export default function ChallengeDataCard({ data, onEdit, onDelete, onRefetch }: ChallengeDataCardProps) {
    return (
        <motion.div
            whileHover={{ y: -3 }}
        ...
        >
            ...
            <p className="text-gray-300 mb-2 md:text-base text-sm leading-relaxed">{data.description}</p>
            <p className="text-gray-400 mb-5 md:text-base text-sm">{data.subDescription}</p>
                ...
                {data.items.map((item, index) => (
                    ...
                    >
                        <div className="flex items-center gap-3 text-gray-200">
                            ...
                            <span className="md:text-sm text-xs font-medium">{item.text}</span>
                        </div>
